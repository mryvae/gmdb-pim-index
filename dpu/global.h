...
extern coo_matrix_dpu global_coo_A;
extern coo_matrix_v_dpu global_plus;
extern coo_matrix_v_dpu global_minus;
extern uint32_t global_coo_A_nnz;
extern uint32_t global_plus_nnz;
extern uint32_t global_minus_nnz;
